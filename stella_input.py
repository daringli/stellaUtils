...
class Stella_input(object):
    ...
    @aky_min.setter
    def aky_min(self,val):
        self.changevar("kt_grids_range_parameters","aky_min",val)

    
    @property
    def aky_max(self):
        return self.get_value_from_input_or_defaults("kt_grids_range_parameters","aky_max")
